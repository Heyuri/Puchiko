...
class databaseConnection {
	...
	private function createPDOConnection() {
		switch ($this->databaseDriver) {
			case 'mysql':
				$dsn = "mysql:host={$this->databaseHost};dbname={$this->databaseName};charset={$this->databaseCharset}";
				break;
			case 'pgsql':
				$dsn = "pgsql:host={$this->databaseHost};dbname={$this->databaseName};";
				break;
			case 'sqlite':
				$dsn = "sqlite:{$this->databaseName}";
				break;
			case 'sqlsrv':
				$dsn = "sqlsrv:Server={$this->databaseHost};Database={$this->databaseName}";
				break;
			default:
				throw new InvalidArgumentException("Unsupported driver: {$this->databaseDriver}");
		}
